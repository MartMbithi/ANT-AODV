...
#TCL FILE FOR ADHOC to test antnet algorithm installation
...
#Open the Trace file
set tf [open antnet.tr w]
$ns trace-all $tf

# nam trace initialization
#set namtrace [open antnet.nam w]     ; # for wireless traces
...
$ns duplex-link $n(0) $n(5) 512Mb 0.5ms DropTail
$ns duplex-link $n(1) $n(2) 512Mb 0.5ms DropTail
$ns duplex-link $n(2) $n(3) 512Mb 0.5ms DropTail
$ns duplex-link $n(2) $n(5) 512Mb 0.5ms DropTail
$ns duplex-link $n(2) $n(7) 512Mb 0.5ms DropTail
$ns duplex-link $n(3) $n(6) 512Mb 0.5ms DropTail
$ns duplex-link $n(3) $n(7) 512Mb 0.5ms DropTail
$ns duplex-link $n(4) $n(5) 512Mb 0.5ms DropTail
$ns duplex-link $n(5) $n(6) 512Mb 0.5ms DropTail
$ns duplex-link $n(5) $n(8) 512Mb 0.5ms DropTail
$ns duplex-link $n(5) $n(9) 512Mb 0.5ms DropTail
$ns duplex-link $n(6) $n(7) 512Mb 0.5ms DropTail
$ns duplex-link $n(6) $n(9) 512Mb 0.5ms DropTail
$ns duplex-link $n(6) $n(10) 512Mb 0.5ms DropTail
$ns duplex-link $n(7) $n(11) 512Mb 0.5ms DropTail
$ns duplex-link $n(9) $n(10) 512Mb 0.5ms DropTail
$ns duplex-link $n(10) $n(11) 512Mb 0.5ms DropTail
